...
length(unique(hna_pcsp_data$patientid)) #303967 patients
...
sum(patients$keepforhna == "INCLUDE") #299048 denominator for HNAs
sum(patients$keepforpcsp == "INCLUDE") #291319 denominator for PCSPs
...
write.csv(patient_level_data, "N:/INFO/_LIVE/NCIN/Macmillan_Partnership/HNAs/COSD level 3 analysis/Data/Patient-level RCRD HNA and PCSP data 20240408.csv")
