...
```{r point_in_pathway, out.width='100%', fig.align='center'}  pathway_data <- pathway_data |>   select(-c(count, total_count, percent_graph)) |>   pivot_wider(names_from = "event_type", values_from = "percent")   kable(pathway_data, align = "llcc", col.names = c("Point in pathway code",                                                   "Point in pathway",                                                    "Proportion of HNAs",                                                    "Proportion of PCSPs")) |>   kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = F, font_size = 12, position = "center")   pathway_graph}
```
