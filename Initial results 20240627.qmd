...
```{r offered_code_matrix, out.width='100%', fig.align='center'}

offered_code_matrix_plot
```
...
age_full_status |>   
  ...
  kable(align = "lc",          
        col.names = c("Age group", "Proportion of patients")) |>   
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),                  full_width = F, font_size = 12, position = "left") 
```
...
######   Figure 9cv: Proportion of patients diagnosed in 2021 with only an offer of a HNA and no PCSP records within 2 years of diagnosis, by gender
